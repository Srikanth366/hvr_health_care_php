...
<body>
    ...
    <section>
        <p> Dear {{ $username }}, </p>
        <p> You've just initiated a password reset for your account. To access your account, simply use the password provided below. Once you're login, don't forget to personalize your security details from the profile tab. Happy logging in!</p>
        <p class="btn" style="text-align:center !important"> {{ $randomPassword }} </p>
